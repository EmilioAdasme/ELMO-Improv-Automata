...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -16.0, 53.0, 205.0, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 12.0, 8.0, 80.0, 25.0 ],
					"text" : "Dispo 1.8"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 218.0, 35.0, 80.0, 20.0 ],
					"text" : "Preset select"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 113.0, 36.0, 80.0, 20.0 ],
					"text" : "Preset switch"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 12.0, 36.0, 69.0, 20.0 ],
					"text" : "Osc switch"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 692.0, 33.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "presetSwitch (0 1)",
					"id" : "obj-45",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1007.666666666666629, 56.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "presetSel (1 3)",
					"id" : "obj-43",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1113.0, 88.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 237.5, 651.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 194.5, 651.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 692.0, 74.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 12.0, 63.0, 41.0, 41.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 500.25, 622.0, 35.0, 22.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 424.0, 614.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 424.0, 663.0, 69.0, 22.0 ],
					"text" : "sfrecord~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1160.0, 96.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1160.0, 146.5, 51.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 218.0, 75.0, 44.0, 17.0 ],
					"preset_data" : [ 						{
							"number" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 253.0, 91.0, 111.0, 117.0 ],
					"xplace" : [ 0.33, 0.66 ],
					"yplace" : [ 0.5, 0.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"pointcolor" : [ 0.43921568627451, 0.43921568627451, 0.43921568627451, 0.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 132.0, 91.0, 111.0, 117.0 ],
					"xplace" : [ 0.33, 0.66 ],
					"yplace" : [ 0.5, 0.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 113.0, 63.0, 41.0, 41.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"pointcolor" : [ 0.43921568627451, 0.43921568627451, 0.43921568627451, 0.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 12.0, 91.0, 111.0, 117.0 ],
					"xplace" : [ 0.33, 0.66 ],
					"yplace" : [ 0.5, 0.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 204.0, 236.0, 97.0, 22.0 ],
					"text" : "syfm 150 75 450"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 454.0, 236.0, 111.0, 22.0 ],
					"text" : "syfm 600 300 1800"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 327.0, 236.0, 104.0, 22.0 ],
					"text" : "syfm 300 150 900"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 455.5, 393.5, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 376.0, 202.0 ]
				}
